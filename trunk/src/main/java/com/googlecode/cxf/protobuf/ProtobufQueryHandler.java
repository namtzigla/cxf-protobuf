...
import com.googlecode.cxf.protobuf.utils.ProtobufUtils;
...
public class ProtobufQueryHandler implements StemMatchingQueryHandler {
    ...
    public boolean isRecognizedQuery(String baseUri, String ctx, EndpointInfo endpointInfo, boolean contextMatchExact) {
        if (baseUri != null
                && (baseUri.contains("?") && (baseUri.toLowerCase().contains("proto")))) {
    ...
    /**
     * 
     * @see org.apache.cxf.transports.http.QueryHandler#getResponseContentType(java.lang.String, java.lang.String)
     */
    ...
    /**
     * 
     * @see org.apache.cxf.transports.http.QueryHandler#isRecognizedQuery(java.lang.String, java.lang.String,
    ...
    /**
     * 
     * @see org.apache.cxf.transports.http.QueryHandler#writeResponse(java.lang.String, java.lang.String,
     *      org.apache.cxf.service.model.EndpointInfo, java.io.OutputStream)
     */
    ...
    public void writeResponse(String fullQueryString, String ctx, EndpointInfo endpoint, OutputStream os) {
        try {
            Class<? extends Message> messageClass = endpoint.getProperty(
                    ProtobufServerFactoryBean.PROTOBUF_MESSAGE_CLASS, Class.class);
            Class<?> serviceClass = endpoint.getProperty(
                    ProtobufServerFactoryBean.PROTOBUF_SERVICE_CLASS, Class.class);
            if (serviceClass != null && Service.class.isAssignableFrom(serviceClass)) {
                PrintStream out = new PrintStream(os);
                ProtobufUtils.convertDescriptorToProto(((ServiceDescriptor) serviceClass.getMethod("getDescriptor").invoke(null)).getFile(), out);
                out.flush();
            } else if (messageClass != null) {
                PrintStream out = new PrintStream(os);
                ProtobufUtils.convertDescriptorToProto(((Descriptor) messageClass.getMethod("getDescriptor").invoke(null)), out);
                out.flush();
            }
        } catch (Exception x) {
